    ...
    <div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
            <div id="reportrange" class="reportrange-picker d-flex align-items-center">
                <i class="isax isax-calendar text-gray-5 fs-14 me-1"></i><span class="reportrange-picker-field">16 Apr 25 - 16
                    Apr 25</span>
            </div>
            <div class="dropdown">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-1"><a href="customer-details.html">Charlotte
                                                        Brown</a>
                                                </h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-0"><a href="customer-details.html">Charlotte
                                                        Brown</a>
                                                </h6>
                                            </div>
                                        </div>
