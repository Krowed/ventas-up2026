...
(function() {
	...
	<link rel="stylesheet" href="assets/css/style-load.css">
</head>
...
<body id="layout-content">
						...
						<ul>
							...
							<li>
								<ul>
									...
									<li>
										<a href="https://kanakku.dreamstechnologies.com/documentation/changelog.html"><i class="isax isax-programming-arrows5"></i><span>Changelog</span><span class="badge bg-primary ms-2 badge-sm text-white fs-12 fw-medium">v2.1.2</span></a>
									</li>
									<li class="submenu">
										<a href="javascript:void(0);">
	...
	<!-- jQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script> 
	
	<!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>

	<!-- Datetimepicker JS -->
	<script src="assets/js/bootstrap-datetimepicker.min.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>

	<!-- Chart JS -->
	<script src="assets/plugins/apexchart/apexcharts.min.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>
	<script src="assets/plugins/apexchart/chart-data.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>

	<!-- Datatable JS -->
	<script src="assets/js/jquery.dataTables.min.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>
    <script src="assets/js/dataTables.bootstrap5.min.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="4ade7af6e63d2907d7dc7864-text/javascript"></script>


<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="4ade7af6e63d2907d7dc7864-|49" defer=""></script></body>
