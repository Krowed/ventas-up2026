...
class TypeDocumentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        [
            ...
            [
                'codigo'        => '14',
                'descripcion'   => 'RECIBO SERVICIOS PÃšBLICOS',
                'estado'        => 0
            ],

            [
                'codigo'        => '15',
                'descripcion'   => 'BOLETOS EMITIDOS POR EL SERVICIO DE TRANSPORTE TERRESTRE REGULAR URBANO DE PASAJEROS Y EL FERROVIARIO PÃšBLICO DE PASAJEROS PRESTADO EN VÍA FÉRREA LOCAL',
                'estado'        => 0
            ],

            [
                'codigo'        => '16',
                'descripcion'   => 'BOLETO DE VIAJE EMITIDO POR LAS EMPRESAS DE TRANSPORTE PÃšBLICO INTERPROVINCIAL DE PASAJEROS',
                'estado'        => 0
            ],
            ...
            [
                'codigo'        => '19',
                'descripcion'   => 'BOLETO POR ATRACCIONES Y ESPECTÁCULOS PÃšBLICOS',
                'estado'        => 0
            ],
            ...
            [
                'codigo'        => '28',
                'descripcion'   => 'ETIQUETAS POR EL PAGO DE LA TARIFA UNIFICADA DE USO DE AEROPUERTO',
                'estado'        => 0
            ],
        ...
        {
            \App\Models\TypeDocument::insert($type_document);
        }
